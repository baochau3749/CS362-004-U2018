...
void testAdventurerCardEffect() {    
    ...
    // ********************************************************************* 
    if ((testGame.discard[currentPlayer][testGame.discardCount[currentPlayer] - 2] == smithy) && 
        (testGame.discard[currentPlayer][testGame.discardCount[currentPlayer] - 1] == village))
