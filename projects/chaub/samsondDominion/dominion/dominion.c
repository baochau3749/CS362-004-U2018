...
int stewardCardEffect(int choice1, int choice2, int choice3, struct gameState *state, int handPos, int currentPlayer)
{
   if (choice1 == 1)
	{
	  // +2 cards
...
int embargoCardEffect(int choice1, struct gameState *state, int handPos, int currentPlayer)
{
   // +2 Coins
   state->coins = state->coins + 2;
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case village:
       return villageCardEffect(state, handPos, currentPlayer);
    ...
    case steward:
       return stewardCardEffect(choice1, choice2, choice3, state, handPos, currentPlayer);
    ...
    case embargo: 
       return embargoCardEffect(choice1, state, handPos, currentPlayer);
